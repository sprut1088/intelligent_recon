...
CREATE TABLE IF NOT EXISTS recon_pattern_versions (id INTEGER PRIMARY KEY AUTOINCREMENT, pattern_key TEXT NOT NULL, version INTEGER NOT NULL, created_at TEXT DEFAULT CURRENT_TIMESTAMP, created_by TEXT DEFAULT 'prototype_user', patterns_json TEXT NOT NULL, UNIQUE(pattern_key, version));
